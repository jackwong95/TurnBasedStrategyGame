...
// source : http://cabbynode.net/
// I can understand the concept of perlin noise, but not the mathematics part 
...
namespace Strategy_Game.GameSystem
{
    public class PerlinNoise
    {
        ...
        public PerlinNoise(double pScale, byte pOctaves)
        {
            XScale = pScale;
            YScale = pScale;
            Octaves = pOctaves;
        ...
        public PerlinNoise(double pXScale, double pYScale, byte pOctaves)
        {
            XScale = pXScale;
            YScale = pYScale;
            Octaves = pOctaves;
